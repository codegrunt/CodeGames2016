...
namespace AxcessAssistant.Dialogs
{
    ...
    public class SendInvoiceDiag : IDialog<object>, IAxcessDiag
    {
        ...
        public async Task MessageReceivedAsync(IDialogContext context, IAwaitable<Message> argument)
        {
            ...
            //{
            //    _doc = inv;
            //    msg.Text = $"Here's invoice {inv.Name}.";
            //    msg.Attachments = new List<Attachment> { new Attachment { Title = inv.FileName, ContentType = "application/json", ContentUrl = $"https://axcessassistantbot.azurewebsites.net/api/files?fileName={inv.FileName}" } };
            //}
            //else
            //{
